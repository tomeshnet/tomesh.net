...
Join us at {{page.startTime | date:"%-I:%M%P "}} on {{ page.date | date: '%B %d, %Y' }} to chat with members of Toronto Mesh! We will talk about our current projects and how you can contribute. We will meet at online in a [Big Blue Button Room]({{ page.locationLink }}).
